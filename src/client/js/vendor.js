    ...
    addClass: function (...e) {
        ...
        for (let r = 0; r < a.length; r += 1) {
            ...
            for (let t = 0; t < this.length; t += 1) {
                const a = this[t];
                let r;
                if (!s && a.dom7Listeners ? r = a.dom7Listeners[e] : s && a.dom7LiveListeners && (r = a.dom7LiveListeners[e]), r && r.length) for (let t = r.length - 1; t >= 0; t -= 1) {
                    const s = r[t];
        ...
        if (this.length > 0) {
            const e = a(), t = i(), s = this[0], n = s.getBoundingClientRect(), r = t.body,
                l = s.clientTop || r.clientTop || 0, o = s.clientLeft || r.clientLeft || 0,
        ...
        if (e.nodeType || e instanceof r) {
            for (l = e.nodeType ? [e] : e, o = 0; o < l.length; o += 1) if (l[o] === n) return !0;
            return !1
        }
        return !1
    }, index: function () {
        ...
        for (let i = 0; i < e.length; i += 1) {
            ...
            } else if (t instanceof r) for (let s = 0; s < t.length; s += 1) this[e].appendChild(t[s]); else this[e].appendChild(t)
        }
        return this
    }, prepend: function (e) {
        const t = i();
        ...
        } else if (e instanceof r) for (n = 0; n < e.length; n += 1) this[s].insertBefore(e[n], this[s].childNodes[0]); else this[s].insertBefore(e, this[s].childNodes[0]);
        return this
    }, next: function (e) {
    ...
    for (let n = 1; n < e.length; n += 1) {
        ...
        if (null != a && (i = a, !("undefined" != typeof window && void 0 !== window.HTMLElement ? i instanceof HTMLElement : i && (1 === i.nodeType || 11 === i.nodeType)))) {
            ...
            for (let s = 0, i = e.length; s < i; s += 1) {
                const i = e[s], n = Object.getOwnPropertyDescriptor(a, i);
...
function v({swiper: e, targetPosition: t, side: s}) {
    const i = a(), n = -e.translate;
    let r, l = null;
    const o = e.params.speed;
    e.wrapperEl.style.scrollSnapType = "none", i.cancelAnimationFrame(e.cssModeFrameID);
    const d = t > n ? "next" : "prev", c = (e, t) => "next" === d && e >= t || "prev" === d && e <= t, p = () => {
        r = (new Date).getTime(), null === l && (l = r);
        const a = Math.max(Math.min((r - l) / o, 1), 0), d = .5 - Math.cos(a * Math.PI) / 2;
        let u = n + d * (t - n);
...
function S(e = {}) {
    return b || (b = function ({userAgent: e} = {}) {
        const t = T(), s = a(), i = s.navigator.platform, n = e || s.navigator.userAgent, r = {ios: !1, android: !1},
            l = s.screen.width, o = s.screen.height, d = n.match(/(Android);?[\s\/]+([\d.]+)?/);
        let c = n.match(/(iPad).*OS\s([\d_]+)/);
        const p = n.match(/(iPod)(.*OS\s([\d_]+))?/), u = !c && n.match(/(iPhone\sOS|iOS)\s([\d_]+)/),
            h = "Win32" === i;
        let f = "MacIntel" === i;
...
function x(e) {
    const t = this, s = i(), n = a(), r = t.touchEventsData, {params: l, touches: o, enabled: c} = t;
    if (!c) return;
...
function M(e) {
    const t = i(), s = this, n = s.touchEventsData, {params: a, touches: r, rtlTranslate: l, enabled: o} = s;
    if (!o) return;
    let c = e;
    ...
    const p = "touchmove" === c.type && c.targetTouches && (c.targetTouches[0] || c.changedTouches[0]),
        h = "touchmove" === c.type ? p.pageX : c.pageX, f = "touchmove" === c.type ? p.pageY : c.pageY;
    ...
    if (n.isTouchEvent && a.touchReleaseOnEdges && !a.loop) if (s.isVertical()) {
...
function $(e) {
    const t = this, s = t.touchEventsData, {params: i, touches: n, rtlTranslate: a, slidesGrid: r, enabled: l} = t;
    if (!l) return;
    let o = e;
    ...
    const g = (h - r[f]) / m, v = f < i.slidesPerGroupSkip - 1 ? 1 : i.slidesPerGroup;
    if (c > i.longSwipesMs) {
...
const A = (e, t) => {
    const s = i(), {params: n, touchEvents: a, el: r, wrapperEl: l, device: o, support: d} = e, c = !!n.nested,
...
function D(e, t) {
    return function (s = {}) {
        ...
        "object" == typeof n && null !== n ? (["navigation", "pagination", "scrollbar"].indexOf(i) >= 0 && !0 === e[i] && (e[i] = {auto: !0}), i in e && "enabled" in n ? (!0 === e[i] && (e[i] = {enabled: !0}), "object" != typeof e[i] || "enabled" in e[i] || (e[i].enabled = !0), e[i] || (e[i] = {enabled: !1}), m(t, s)) : m(t, s)) : m(t, s)
    }
}
...
const B = {
    eventsEmitter: {
        ...
        updateSize: function () {
            ...
            let C = i.spaceBetween, T = -m, S = 0, y = 0;
            if (void 0 === a) return;
            ...
            for (let g = 0; g < p; g += 1) {
                ...
                if (E && e.grid.updateSlide(g, n, p, t), "none" !== n.css("display")) {
                    if ("auto" === i.slidesPerView) {
                        M && (c[g].style[t("width")] = "");
                        const a = getComputedStyle(n[0]), r = n[0].style.transform, l = n[0].style.webkitTransform;
                        if (r && (n[0].style.transform = "none"), l && (n[0].style.webkitTransform = "none"), i.roundLengths) x = e.isHorizontal() ? n.outerWidth(!0) : n.outerHeight(!0); else {
                            const e = s(a, "width"), t = s(a, "padding-left"), i = s(a, "padding-right"),
                                r = s(a, "margin-left"), l = s(a, "margin-right"), o = a.getPropertyValue("box-sizing");
                            if (o && "border-box" === o) x = e + r + l; else {
            ...
            if (e.virtualSize = Math.max(e.virtualSize, a) + v, r && l && ("slide" === i.effect || "coverflow" === i.effect) && n.css({width: `${e.virtualSize + i.spaceBetween}px`}), i.setWrapperSize && n.css({[t("width")]: `${e.virtualSize + i.spaceBetween}px`}), E && e.grid.updateWrapperSize(x, u, t), !i.centeredSlides) {
                const t = [];
            ...
            if (0 === u.length && (u = [0]), 0 !== i.spaceBetween) {
                ...
                c.filter(((e, t) => !i.cssMode || t !== c.length - 1)).css({[s]: `${C}px`})
            }
            ...
            const t = this, s = t.params, i = d(e.target).closest(`.${s.slideClass}`)[0];
            let n, a = !1;
            if (i) for (let r = 0; r < t.slides.length; r += 1) if (t.slides[r] === i) {
                a = !0, n = r;
                break
            }
        ...
        slideTo: function (e = 0, t = this.params.speed, s = !0, i, n) {
            ...
            const w = -o[g];
            if (a.updateProgress(w), l.normalizeSlideIndex) for (let v = 0; v < d.length; v += 1) {
                const e = -Math.floor(100 * w), t = Math.floor(100 * d[v]), s = Math.floor(100 * d[v + 1]);
            ...
            if (l.cssMode) {
                ...
                if (0 === t) {
                    ...
                    if (!a.support.smoothScroll) return v({swiper: a, targetPosition: s, side: e ? "left" : "top"}), !0;
            ...
            const n = this;
            let a = n.activeIndex;
            const r = Math.min(n.params.slidesPerGroupSkip, a), l = r + Math.floor((a - r) / n.params.slidesPerGroup),
        ...
        loopCreate: function () {
            const e = this, t = i(), {params: s, $wrapperEl: n} = e, a = d(n.children()[0].parentNode);
        ...
        attachEvents: function () {
            const e = this, t = i(), {params: s, support: n} = e;
        ...
        setBreakpoint: function () {
            ...
            const o = (l in r ? r[l] : void 0) || e.originalParams, d = z(e, n), c = z(e, o), p = n.enabled;
            ...
            let i = !1;
            const n = a(), r = "window" === t ? n.innerHeight : s.clientHeight, l = Object.keys(e).map((e => {
        ...
        addClasses: function () {
            const e = this, {classNames: t, params: s, rtl: i, $el: n, device: a, support: r} = e, l = function (e, t) {
                const s = [];
                return e.forEach((e => {
...
class _ {
    constructor(...e) {
        ...
        const i = this;
        i.__swiper__ = !0, i.support = T(), i.device = S({userAgent: s.userAgent}), i.browser = y(), i.eventsListeners = {}, i.eventsAnyListeners = [], i.modules = [...i.__modules__], s.modules && Array.isArray(s.modules) && i.modules.push(...s.modules);
        const n = {};
        i.modules.forEach((e => {
            e({
                swiper: i,
...
function H({swiper: e, extendParams: t, on: s, emit: i}) {
    ...
    t({
        ...
        const {$nextEl: n, $prevEl: a} = e.navigation, r = s.target;
...
function V({swiper: e, extendParams: t, on: s, emit: i}) {
    ...
    function c() {
        ...
        if (e.params.loop ? (p = Math.ceil((e.activeIndex - e.loopedSlides) / e.params.slidesPerGroup), p > n - 1 - 2 * e.loopedSlides && (p -= n - 2 * e.loopedSlides), p > u - 1 && (p -= u), p < 0 && "bullets" !== e.params.paginationType && (p = u + p)) : p = void 0 !== e.snapIndex ? e.snapIndex : e.activeIndex || 0, "bullets" === s.type && e.pagination.bullets && e.pagination.bullets.length > 0) {
            ...
            if (s.dynamicBullets && (a = i.eq(0)[e.isHorizontal() ? "outerWidth" : "outerHeight"](!0), c.css(e.isHorizontal() ? "width" : "height", a * (s.dynamicMainBullets + 4) + "px"), s.dynamicMainBullets > 1 && void 0 !== e.previousIndex && (r += p - e.previousIndex, r > s.dynamicMainBullets - 1 ? r = s.dynamicMainBullets - 1 : r < 0 && (r = 0)), n = p - r, l = n + (Math.min(i.length, s.dynamicMainBullets) - 1), u = (l + n) / 2), i.removeClass(["", "-next", "-next-next", "-prev", "-prev-prev", "-main"].map((e => `${s.bulletActiveClass}${e}`)).join(" ")), c.length > 1) i.each((e => {
                ...
                const t = i.eq(p), a = t.index();
                if (t.addClass(s.bulletActiveClass), s.dynamicBullets) {
                    const t = i.eq(n), r = i.eq(l);
                    ...
                    } else o(t, "prev"), o(r, "next"); else o(t, "prev"), o(r, "next")
                }
            }
            if (s.dynamicBullets) {
                const n = Math.min(i.length, s.dynamicMainBullets + 4), r = (a * n - a) / 2 - u * a,
                    l = t ? "right" : "left";
    ...
    s("init", (() => {
        ...
        const n = s.target, {$el: a} = e.pagination;
...
})), _.use([function ({swiper: e, on: t, emit: s}) {
    const i = a();
    let n = null;
    const r = () => {
